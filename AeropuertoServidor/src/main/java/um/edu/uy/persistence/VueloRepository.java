...
public interface VueloRepository extends JpaRepository<Vuelo,Long> {
    ...
    List<Vuelo> findAllByFechaETAAndAeropuertoOrigenAndAceptadoDestinoAndAceptadoOrigen(LocalDate fechaLlegada, Aeropuerto aeropuerto, boolean aceptadoorigen, boolean aceptadodestino);
}
